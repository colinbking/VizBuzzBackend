...
def add_pitch_to_output(output_format, filename="out_wavs/The_smoking_tire_daniel_osborne.wav", cut=5):
    ...
    for idx, tes in enumerate(med_output):
        ...
        _ = rigged_format.readframes(frame_from_ns(tes['Offset'] - last_o_d))
